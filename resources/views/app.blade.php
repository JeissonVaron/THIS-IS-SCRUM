        ...
        <section id="hero">
            <div class="hero-container">
                <div class="wow fadeIn">
                    ...
                    <h2> <span class="rotating">Gestiona criterios, proyectos, historias, Sprints, tareas, todo tu proyecto!</span></h2>
                    <h2>Mediante la metodología Scrum</h2>
                    <div class="actions">
                        <a href="#about" class="btn-get-started">Mas jsabdnsjkdbfsdbf</a>
        ...
        <header id="header">
            <div class="container">
                ...
                <div id="logo" class="pull-left">
                    <img src="logo.png">
                    <img src="img/logo.png" alt="" title="" /><a href="#hero"></a>
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li><a href="create-user.html">REGISTRATE</a></li>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="form-group col-md-3 subscribe-btn-container">
                            <a class="subscribe-btn" href="#">registrate ahora</a>
                        </div>
                        <div class="form-group col-md-3 subscribe-btn-container">
                            <a class="subscribe-btn" href="login.html">Iniciar sesión</a>
                        </div>
                    </div>
