        ...
        <div class="col-md-9 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::open(['route' => 'Sprints.store', 'method' => 'POST']) !!}              
                        <div class="form-group">
                            {!! Form::label('name', 'Descripcion') !!}
                            {!! Form::textarea('description', null, ['class' =>'form-control', 'requerid', 'placeholder' => 'Escriba la descripcion del sprint']) !!}
                        </div>

                        <div class="form-group">
                            {!! Form::label('name', 'Fecha de finalizacion') !!}
                            <input type="datetime-local" name="final_date" class="form-control" required>
