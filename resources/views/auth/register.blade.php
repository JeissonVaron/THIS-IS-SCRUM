                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        {{ csrf_field() }}
                         ...
                         <div class="form-group{{ $errors->has('id_user') ? ' has-error' : '' }}">
                            <label for="id_user" class="col-md-4 control-label">Cedula</label>

                            <div class="col-md-6">
                                <input id="id_user" type="text" class="form-control" name="id_user" value="{{ old('id_user') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('fk_state_id') ? ' has-error' : '' }}">
                            <label for="fk_state_id" class="hidden">Estado</label>

                            <div  class="col-md-6" >
                            <select id="fk_state_id"  class="hidden" name="fk_state_id" required>  
                            ...
                            <option value="1">Activo</option>
                                ...
                                @if ($errors->has('fk_state_id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('fk_state_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>

                         <div class="form-group{{ $errors->has('fk_profile_id') ? ' has-error' : '' }}">
                            <label for="fk_profile_id" class="hidden">Perfil</label>

                            <div  class="col-md-6" >
                            <select id="fk_profile_id"  class="hidden" name="fk_profile_id" required>  
                            <option value="1">Usuario</option>
                            <option value="0">Administrador</option>
                            </select>

                                @if ($errors->has('fk_profile_id'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('fk_profile_id') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
